...
def build_transformer_model(input_shape, num_layers, d_model, dff, maximum_position_encoding, output_shape, rate=0.1):
    ...
    outputs = Dense(output_shape[-1])(tf.tile(enc_output1, [1, 8, 1])[:,:720,:])    
...
F_Net_model.load_weights('Weight_FNet_720_ETTh1.tf') # change name here
...
model.load_weights('Weight_EFNet_720_ETTh1.tf') # change name here
